...
describe User do
  ...
  describe "micropost associations" do
    ...
    describe "status" do
      ...
      it{expect(@user.feed).to include(newer_micropost)} # its(:feed) { should include(newer_micropost) }
...
it{expect(@user.feed).to include(*followed_user.microposts)}
 ...
 describe "followed user" do
    ...
    describe "and unfollowing" do
      ...
      it { expect(@user.followed_users).not_to include(other_user) }#its(:followed_users) { should_not include(other_user) }
    end
  end
end
